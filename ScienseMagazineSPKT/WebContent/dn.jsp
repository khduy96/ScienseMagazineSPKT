						...
						<div class="col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-tiile" align="center">Đăng nhập</h4>
								</div>
								<div class="panel-body">
									<form ng-app="myApp" ng-controller="validateCtrl" name="myForm"
										novalidate method="post" action="login.jsp">
										<form class="form-horizontal">
											...
											<div class="col-sm-10">
												<p>
													...
													<div class="panel-body">
														<div class="form-group" align="center">
															<img src="image/login.jpg" alt="login" vspace="5px"
																hspace="5px" style="width: 130px; height: 130px;" />
														</div>
														<div class="form-group">
															<input type="radio" checked="checked" name="1"
																value="DocGia">Đọc Giả </label> <label
																class="radio-inline"> <input type="radio"
																	name="1" value="TacGia">Tác Giả </label> <label
																class="radio-inline"> <input type="radio"
																	name="1" value="TongBienTap">Tổng biên tập </label> <label
																class="radio-inline"> <input type="radio"
																	name="1" value="PhanBienVien">Phản biện viên </label> <label
																class="radio-inline"> <input type="radio"
																	name="1" value="BienTapVien">Biên tập viên </label> <label
																class="radio-inline"> <input type="radio"
																	name="1" value="Admin">Admin </label>
														</div>
														<div class="form-group">
															<label style="margin: 0 0 30 0;">Tên đăng nhập*:</label>
															<div>
														...
														<div class="form-group" style="clear: both;">
															<label style="margin: 0 0 30 0;">Mật khẩu:</label>
															<div>
												...
												<div class="form-group" align="center">
													<br> <br>Bạn chưa có tài khoản??<a href="dk.jsp"
															style="color: #00BFFF;">Đăng ký ngay</a>
												</div>
												</p>
											</div>
											<div class="col-sm-1"></div>
