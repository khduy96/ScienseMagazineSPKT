				...
				<div class="container">
					<div class="panel panel-default navbar-nav">
						<div class="panel panel-heading">
							<div class="row">Danh sách bài đã biên tập</div>
						</div>
									...
									<tbody>
										<c:forEach var="row" items="${result.rows}">
											...
											<tr>
												...
												<td>
													<button class="btn btn-default" type="submit"
														data-toggle="modal"
														data-target="#${sessionScope['iduser']}"
														style="float: left;">
														<span class="glyphicon glyphicon-option-horizontal"></span>
													</button>
												</td>
												<td><form action="z_guibt.jsp" method="post">
														<input type="hidden" value="${sessionScope['iduser']}"
															name="id" /><input class="btn btn-default" type="submit"
															value="Biên tập lại" />
													</form></td>
												<td align="right"><form action="z_duyet.jsp"
														method="post">
														<input type="hidden" value="${sessionScope['iduser']}"
															name="id" /><input class="btn btn-default" type="submit"
															value="Duyệt" />
											...
											<div class="modal fade bs-example-modal-lg"
												id="${sessionScope['iduser']}" role="dialog">
