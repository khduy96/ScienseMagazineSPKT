...
SELECT * from baiviet where tinhtrang='pbv';
</sql:query>
				`
								...
								<tbody>
									<c:forEach var="row" items="${result.rows}">
										...
										<tr>
											...
											<td align="right"><form action="pbv_pb.jsp" method="get">
													<input type="hidden" value="${sessionScope['idbv']}"
														name="idbv" /><input class="btn btn-default"
														type="submit" value="Phản biện" />
												</form></td>
											<td align="right"><form action="z_pbnopbai.jsp"
													method="post">
													<input type="hidden" value="<%=session.getAttribute("cv")%>" name="cv" />
													<input type="hidden" value="${sessionScope['idbv']}"
														name="idbv" /><input class="btn btn-default"
														type="submit" value="Nộp" />
												</form></td>
										</tr>
									</c:forEach>
								</tbody>
