		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div>
					...
					<form action="z_viewsearch.jsp" method="get">
						<table>
							<tr>
						...
						<div class="col-md-8">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form id="main" ng-app="RegisterApp"
										ng-controller="RegisterCtrl" name="myForm"
										ng-submit="register()" novalidate method="post"
										action="registration.jsp">
										<form class="form-horizontal">
											<div class="form-group  has-feedback"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required " for="user">Tên
													đăng nhập*:</label>
												<div class="has-feedback">
													<input type="text" name="user" class="form-control"
														placeholder="Tên đăng nhập" ng-model="user"
														ng-minlength="6" ng-maxlength="24"
														ng-pattern="/^[a-zA-Z0-9]+$/" required/> <i
														style="color: green"
														class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
														ng-show="myForm.user.$dirty && myForm.user.$valid"> </i> <span
														style="color: red"
														ng-show="myForm.user.$dirty && myForm.user.$invalid">
															<span ng-show="myForm.user.$error.minlength">Tên
																đăng nhập từ 6-24 ký tự.</span> <span
															ng-show="myForm.user.$error.maxlength">Tên đăng
																nhập từ 6-24 ký tự.</span> <span
															ng-show="myForm.user.$error.pattern">Tên đăng nhập
																phải không dấu không cách và không có ký tự đặc biệt.</span>
													</span> <span style="color: red"
														ng-show="myForm.user.$touched && myForm.user.$invalid">
															<span ng-show="myForm.user.$error.required">Tên
																đăng nhập từ 6-24 ký tự.</span>
													</span>
												</div>
											</div>
											<div class="form-group has-feedback"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required" for="password">Mật
													khẩu*:</label>
												<div class="has-feedback">
													<input type="password" name="password" class="form-control"
														placeholder="Password" ng-model="password"
														ng-minlength="6" ng-maxlength="24"
														class="ng-pristine ng-valid" required/> <i
														style="color: green"
														class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
														...
														ng-show="myForm.password.$dirty && myForm.password.$invalid">
															<span ng-show="myForm.password.$error.minlength">Mật
																khẩu từ 6-32 ký tự.</span> <span
															ng-show="myForm.user.$error.maxlength">Mật khẩu từ
																6-32 ký tự.</span>
													</span><span style="color: red"
														ng-show="myForm.password.$touched && myForm.password.$invalid">
															<span ng-show="myForm.password.$error.required">Bạn
																cần nhập Mật khẩu.</span></span>
												</div>
											</div>
											<div class="form-group
								has-feedback" ng-app="myApp"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required " for="repassword">Xác
													nhận mật khẩu*:</label>
												<div class="has-feedback">
													<input type="password" name="repassword"
														class="form-control" id="exampleInputPassword2"
														placeholder="Repassword" ng-model="repassword"
														password-match="password" required/> <i
														style="color: green"
														class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
														ng-show="myForm.repassword.$dirty && myForm.repassword.$valid">
													</i> <span style="color: red"
														ng-show="myForm.repassword.$dirty && myForm.repassword.$invalid && myForm.repassword.$error.unique">Mật
															khẩu không trùng khớp.</span> <span style="color: red"
														ng-show="myForm.repassword.$touched && myForm.repassword.$invalid">
															<span ng-show="myForm.repassword.$error.required">Bạn
																cần Xác nhận mật khẩu.</span></span>
												</div>
											</div>
											<div class="form-group has-feedback"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required " for="email">Địa
													chỉ email*:</label>
												<div class="has-feedback">
													<p>
														<input type="email" name="email" class="form-control"
															placeholder="Email" ng-model="email" required/> <i
															style="color: green"
															class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
															ng-show="myForm.email.$dirty && myForm.email.$valid">
														</i> <span style="color: red"
															ng-show="myForm.email.$dirty && myForm.email.$invalid">
																<span ng-show="myForm.email.$error.email">Không
																	đúng định dạng email.</span>
														</span> <span style="color: red"
															ng-show="myForm.email.$touched && myForm.email.$invalid">
																<span ng-show="myForm.email.$error.required">Bạn
																	cần nhập Địa chỉ email.</span>
														</span>
													</p>
												</div>
											</div>
											<div class="form-group" style="clear: both;">
												...
												<div class="has-feedback">
													<p>
														Nam<input type="radio" checked="checked" name="gt"
															value="nam" style="margin: 0 20 0 20;"/> Nữ <input
															type="radio" name="gt" value="nu"
											...
											<div class="form-group" style="clear: both;">
												...
												<div class="has-feedback"><%-- 
													<fmt:formatDate var="fmtDate"
														value="${form.bean.dateProperty}" pattern="dd/MM/yyyy" /> --%>
													<input type="date" class="form-control" name="birthday"
														<%-- value="${fmtDate}"  --%>/>
													<%-- <input type="date" name="birthday" class="form-control" value='${fmtDate}'/> --%>
												</div>
											</div>

											<div class="form-group has-feedback"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required " for="phone">Điện
													thoại*:</label>
												<div class="has-feedback">
													<input type="text" name="phone" class="form-control"
														placeholder="Phone" ng-model="phone" ng-minlength="10"
														ng-maxlength="12" ng-pattern="/^[0-9]+$/" required/><i
														style="color: green"
														class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
														ng-show="myForm.phone.$dirty && myForm.phone.$valid">
													</i> <span style="color: red"
														ng-show="myForm.phone.$dirty && myForm.phone.$invalid">
															<span ng-show="myForm.phone.$error.minlength">Đây
																không phải là số diên thoại.</span> <span
															ng-show="myForm.phone.$error.maxlength">Đây không
																phải là số điên thoại.</span> <span
															ng-show="myForm.phone.$error.pattern">Hãy nhập số.</span>
													</span> <span style="color: red"
														ng-show="myForm.phone.$touched && myForm.phone.$invalid">
															<span ng-show="myForm.phone.$error.required">Bạn
											...
											<div class="form-group has-feedback"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required " for="CMND">Số
													CMND*:</label>
												<div class="has-feedback">
													<input type="text" name="CMND" class="form-control"
														placeholder="CMND" ng-model="CMND" ng-minlength="9"
														ng-maxlength="9" ng-pattern="/^[0-9]+$/" required/>
														<i style="color: green"
														class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
														ng-show="myForm.CMND.$dirty && myForm.CMND.$valid"> </i> <span
														style="color: red"
														ng-show="myForm.CMND.$dirty && myForm.CMND.$invalid"/>
															<span ng-show="myForm.CMND.$error.minlength">Đây
																không phải là số CMND.</span> <span
															ng-show="myForm.CMND.$error.maxlength">Đây không
																phải là số CMND.</span> <span
															ng-show="myForm.CMND.$error.pattern">Hãy nhập số.</span>
													</span> <span style="color: red"
														ng-show="myForm.CMND.$touched && myForm.CMND.$invalid">
															<span ng-show="myForm.CMND.$error.required">Bạn
																cần nhập CMND.</span>
													</span>
												</div>
											</div>
											<div class="form-group" style="clear: both;">
												...
												<div class="has-feedback">
													<p>
														<textarea name="tcq" class="form-control"
															placeholder="Tên cơ quan" rows="4" required></textarea>
													</p>
												</div>
											</div>
											<div class="form-group" style="clear: both;">
												...
												<div class="has-feedback">
													<p>
														<textarea name="dc" class="form-control"
															placeholder="Địa chỉ   " rows="4" required></textarea>
													</p>
												</div>
											</div>
											<div class="form-group has-feedback"
												show-errors='{showSuccess: true}' style="clear: both;">
												<label class="control-label required " for="email1">Địa
													chỉ email dự phòng*:</label>
												<div class="has-feedback">
													<p>
														<input type="email" name="email1" class="form-control"
															placeholder="Email" ng-model="email1" required/> <i
															style="color: green"
															class="form-control-feedback glyphicon glyphicon-password glyphicon-ok"
															ng-show="myForm.email1.$dirty && myForm.email1.$valid">
														</i> <span style="color: red"
															ng-show="myForm.email1.$dirty && myForm.email1.$invalid"/>
																<span ng-show="myForm.email1.$error.email">Không
																	đúng định dạng email.</span>
														</span> <span style="color: red"
															ng-show="myForm.email1.$touched && myForm.email1.$invalid">
																<span ng-show="myForm.email1.$error.required">Bạn
																	cần nhập Địa chỉ email dự phòng.</span>
														</span>
													</p>
												</div>
											</div>
											<p>
												<br/> <span id="helpBlock" class="help-block">*
														Chỉ các trường hợp bắt buộc.</span>
											</p>
											<div class="form-group" align="center">
												<input type="submit" value="Đăng ký" class="btn btn-default"
													...
													title="Bạn phải nhập đầy đủ các thông tin bắt buộc" />
											</div>
										</form>
									</form>
			...
			<div class="collapse navbar-collapse"
				...
				<div class="nav navbar-nav">
					<ul class="nav navbar-nav ">
						<li><a data-toggle="tab" href="tc.jsp"> TRANG CHỦ </a></li>
						<li><a data-toggle="tab" href="#cctc">CƠ CẤU TỔ CHỨC</a></li>
						<li><a data-toggle="tab" href="#qd">QUY ĐỊNH</a></li>
						<li><a data-toggle="tab" href="#lh"> LIÊN HỆ </a></li>
					</ul>
						...
						function($timeout, showErrorsConfig) {
							...
							linkFn = function(scope, el, attrs, formCtrl) {
								...
								return toggleClasses = function(invalid) {
									...
									if (showSuccess) {
										return el.toggleClass('has-success',
												!invalid);
									}
								};
							};
