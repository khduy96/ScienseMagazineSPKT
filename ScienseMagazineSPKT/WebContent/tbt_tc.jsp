...
SELECT * from vol ORDER BY vol_id DESC;
						...
						<c:forEach var="rowvol" items="${vol.rows}">
							<c:set var="idvol" value="${rowvol.vol_id}" scope="session" />
							
							<div class="col-md-12">
								<div class="container">
									<div class="panel panel-default nav navbar-nav nav-tabs">
										<div class="panel panel-heading">
											<h4 class="panel-tiile" align="center">
												VOLUME
												<c:out value="${rowvol.vol_id}"></c:out>
											</h4>
										</div>
										<div class="panel-body">
											<div class="container "
												style="height: 200px; overflow: auto; padding: 5px">
												<sql:query dataSource="${snapshot}" var="result">
SELECT * from baiviet where vol_id='${rowvol.vol_id}'and dang='T' ;
</sql:query>
												<c:forEach var="row" items="${result.rows}">
													<c:set var="idbv" value="${row.baiviet_id}"
														scope="session" />
													<div class="row ">
														<div class="col-md-10">
															<a
																href="../ScienseMagazineSPKT/bl.jsp?idbv=${sessionScope['idbv']}">
