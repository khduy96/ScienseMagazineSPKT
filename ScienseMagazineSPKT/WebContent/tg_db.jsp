...
<%
	...
	if (asd == null) {
		...
		if (new String("DocGia").equals(cv)) {
					...
					<div class="row">
						...
						<div class="col-md-10">
							<form ng-app="myApp" ng-controller="validateCtrl" name="myForm"
								novalidate method="post" action="uploadServlet"
								enctype="multipart/form-data">
								<form class="form-horizontal">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-tiile" align="center" style="">Đăng bài</h4>
										</div>
										<div class="panel-body">
											...
											<div class="form-group" style="clear: both;">
												<label>Tiêu đề</label> <input type="text" name="head"
													class="form-control" />
											</div>
											<div class="form-group" style="clear: both;">
											...
											<label>File đính kèm</label> <input type="file" name="photo"
												class="form-control" fileread="vm.uploadme"/> <br />
											...
											<div class="form-group" style="clear: both;">
												<form class="form-horizontal">
													<table class="table table-striped">
														<tbody>
															<tr>
																<th align="center"><b>Tên tác giả </b></th>
																<th align="center" colspan='2'><b>Cơ quan công
																		tác</b></th>
																<th></th>
															</tr>
															<tr>
											...
											<h3>
												Lĩnh vực<select name="Mon" class="form-control">
												...
												<div>
													<p>
														<input type="email" name="email" class="form-control"
															placeholder="Email" ng-model="email" required /> <span
															style="color: red"
															...
															<span ng-show="myForm.email.$error.required">Địa
																chỉ email là bắt buộc.</span>
														</span>
													</p>
												</div>
											</div>
												...
												<div>
													<p>
														<input type="text" name="phone" class="form-control"
															...
															ng-maxlength="12" ng-pattern="/^[0-9]+$/" required /> <span
															style="color: red"
															...
															ng-show="myForm.phone.$error.maxlength">Đây không
																phải là số diên thoại.</span> <span
											...
											<div class="form-group" style="clear: both;">
												<label class="col-sm-2">Từ khóa :</label> <input type="text"
													name="tukhoa1" class="col-sm-2" /> <input type="text"
													name="tukhoa2" class="col-sm-2" /> <input type="text"
													name="tukhoa3" class="col-sm-2" /> <input type="text"
													name="tukhoa4" class="col-sm-2" /> <input type="text"
													name="tukhoa5" class="col-sm-2" />
											</div>
											<p>
												<br /> <span id="helpBlock" class="help-block">* Chỉ
													các trường hợp bắt buộc.</span>
											</p>
											<div class="form-group" style="clear: both;" align="center">
