				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<button class="btn btn-default dropdown-toggle" type="button"
							...
							<span class="glyphicon glyphicon-cog"></span>Đọc giả
						</button>
										...
										<div class="panel-body">
											<div class="container "
												...
												<c:forEach var="row" items="${result.rows}">
													...
													<div class="row ">
														<div class="col-md-10">
														<a href="../ScienseMagazineSPKT/bl.jsp?idbv=${sessionScope['idbv']}"><c:out value="${row.tieude}"></c:out>
														</a>
														</div>
														<div class="col-md-2">
