...
SELECT * from baiviet where tinhtrang = 'pbv' and dang='F' and trangthai = 'dangpb' ;
</sql:query>
				<div class="panel panel-default navbar-nav">
					<div class="panel panel-heading">Danh sách bài viết đang
						trong quá trình phản biện</div>
									...
									<c:forEach var="row" items="${result.rows}">
										...
										<tr>
											...
											<td><input type="hidden"
												value="${sessionScope['idbv']}modal" name="idbv" />
