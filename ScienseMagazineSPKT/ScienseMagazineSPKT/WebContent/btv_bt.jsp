				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<button class="btn btn-default dropdown-toggle" type="button"
							...
							<span class="glyphicon glyphicon-cog"></span>Biên tập viên
						</button>
...
SELECT * from baiviet where baiviet_id=? ;
            <sql:param value="${param.idbv}" />
				...
				<c:forEach var="row" items="${result.rows}">
					...
					<form action="z_savebt.jsp" method="post">
						...
						<div class="panel panel-default">
							...
							<div class="form-group" style="clear: both;">
								<label>Tiêu đề</label> <input type="text" name="head"
									value="${row.tieude}" class="form-control" />
							</div>
							<div class="form-group" style="clear: both;">
								<label>Nội dung chính</label>
								<textarea name="editor1" id="editor1" rows="10" cols="80">${row.noidung}</textarea>
								<script>
										...
										<tbody>
											...
											<tr>
												<td><input class="form-control" disabled="disabled"
													value="${row.tacgia_id}" type="text" name="11" /></td>
												<td><input disabled="disabled" class="form-control"
													value="${row.coquan}" type='text' name="21" /></td>
											</tr>
											<tr>
												<td><input class="form-control" disabled="disabled"
													value="${row.tacgia_id1}" type="text" name="12" /></td>
												<td><input disabled="disabled" class="form-control"
													value="${row.coquan1}" type='text' name="22" /></td>
											</tr>
											<tr>
												<td><input class="form-control" disabled="disabled"
													value="${row.tacgia_id2}" type="text" name="13" /></td>
												<td><input disabled="disabled" class="form-control"
													value="${row.coquan2}" type='text' name="23" /></td>
											</tr>
											<tr>
												<td><input class="form-control" disabled="disabled"
													value="${row.tacgia_id3}" type="text" name="14" /></td>
												<td><input disabled="disabled" class="form-control"
													value="${row.coquan3}" type='text' name="24" /></td>
											</tr>
											<tr>
												<td><input class="form-control" disabled="disabled"
													value="${row.tacgia_id4}" type="text" name="15" /></td>
												<td><input disabled="disabled" class="form-control"
													value="${row.coquan4}" type='text' name="25" /></td>
											</tr>
										</tbody>
									</table>
								</div>
								<h3>
									Lĩnh vực<select name="Mon" class="form-control">
										<option id="hiden" selected="selected">${row.linhvuc}</option>
								...
								<div class="form-group" style="clear: both;">
									...
									<div>
										<input type="text" disabled="disabled" value="${row.sdt}"
											class="form-control" />
									</div>
								</div>
								<div class="form-group" style="clear: both;">
									<label class="col-sm-2">Từ khóa :</label> <input type="text"
										value="${row.tukhoa1}" name="tukhoa1" class="col-sm-2" /> <input
										type="text" value="${row.tukhoa2}" name="tukhoa2"
										class="col-sm-2" /> <input type="text" value="${row.tukhoa3}"
										name="tukhoa3" class="col-sm-2" /> <input type="text"
										value="${row.tukhoa4}" name="tukhoa4" class="col-sm-2" /> <input
										type="text" value="${row.tukhoa5}" name="tukhoa5"
										class="col-sm-2" />
								</div>
							</div>
							<br /> <br /> <input type="hidden"
								value="${sessionScope['idbv']}" name="idbv" />
							<center>
