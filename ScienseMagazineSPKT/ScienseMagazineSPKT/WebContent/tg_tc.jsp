				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="tg_dspb.jsp">Bài viết đang trong quá trình phản biện</a></li>
...
SELECT * from baiviet where vol_id='${rowvol.vol_id}' ;
</sql:query>
							<div class="col-md-12">
								<div class="container">
										...
										<div class="panel-body">
											<div class="container "
												...
												<c:forEach var="row" items="${result.rows}">
													...
													<div class="row ">
														<div class="col-md-10">
															<a href="../ScienseMagazineSPKT/bl.jsp?idbv=${sessionScope['idbv']}"> <c:out
																	value="${row.tieude}"></c:out>
															</a>
														</div>
														<div class="col-md-2">
		...
		<div class="navbar-header navbar-right">
			...
			<div class="collapse navbar-collapse"
				...
				<div class="nav navbar-nav">
					<ul class="nav navbar-nav nav-tabs">
						<li><a data-toggle="tab" href="#home"> TRANG CHỦ </a></li>
						<li><a data-toggle="tab" href="#cctc">CƠ CẤU TỔ CHỨC</a></li>
						<li><a data-toggle="tab" href="#qd">QUY ĐỊNH</a></li>
						<li><a data-toggle="tab" href="#lh"> LIÊN HỆ </a></li>
					</ul>
