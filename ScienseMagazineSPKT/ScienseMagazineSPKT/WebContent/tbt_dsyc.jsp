...
SELECT * from baiviet where tinhtrang = 'tbt' and dang='F' and trangthai = 'chuaduyet' ;
				...
				<div class="container">
					<div class="panel panel-default navbar-nav ">
						<div class="panel panel-heading">Danh sách yêu cầu đăng bài
						</div>
								...
								<table class="table table-striped">
									...
									<tbody>
										<c:forEach var="row" items="${result.rows}">
											<c:set var="iduser" value="${row.baiviet_id}" scope="session" />
											<tr>
												<td><a
													href="../ScienseMagazineSPKT/FileReadPdf?PDF=${sessionScope['iduser']}"><c:out
												...
												<td><form action="z_guipb.jsp" method="post">
														<input type="hidden" value="${sessionScope['iduser']}"
															name="id" /><input class="btn btn-default" type="submit"
															value="Gửi phản biện" />
													</form></td>
												<td align="right"><form action="z_huybai.jsp"
														method="post">
														<input type="hidden" value="${sessionScope['iduser']}"
															name="id" /><input class="btn btn-danger" type="submit"
															value="Hủy bài viết" />
													</form></td>
											</tr>
												...
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<a
																href="../ScienseMagazineSPKT/downloadFileServlet?id=${sessionScope['iduser']}">
																DƠNLOAD </a>
														</div>
